    ...
    return (
        <div className="flex flex-1 justify-center gap-2">
            ...
            <div className="flex-1 flex flex-cols nowrap items-center border-b">
                ...
                <button className="text-white pt-0 w-6 h-6 bg-accent rounded-full font-bold" onClick={()=>dispatch(addToCart(product,-1))}>-</button>
                ...
                <button className="text-white pt-0 w-6 h-6 bg-gray-300 ml-4 rounded-full font-bold" onClick={()=>dispatch(addToCart(product,0))}>X</button>
            </div>
        </div>
    )
}
